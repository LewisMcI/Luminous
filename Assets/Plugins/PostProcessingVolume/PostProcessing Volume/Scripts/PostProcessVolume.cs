...
public class PostProcessVolume : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.tag == "Player")
        {
            GameObject tempCam = other.transform.Find("CameraController").Find("Main Camera").gameObject;
            PostProcessVolumeReceiver receivers = tempCam.GetComponent<PostProcessVolumeReceiver>();
